...
class CQLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        indi_terminated = terminated.repeat(1,1,self.n_agents).float()
    ...
    def load_models(self, path):
        ...
        self.q_optimiser.load_state_dict(th.load("{}/q_opt.th".format(path), map_location=lambda storage, loc: storage))s